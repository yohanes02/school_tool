						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<form class="row g-3 needs-validation" method="post" action="<?= base_url() ?>auth/loginUser">
										...
										<div class="col-12 text-center">
											<p class="small mb-0">Masuk sebagai siswa? <a href="<?= base_url() ?>auth/loginStudent">Masuk</a></p>
										</div>
									</form>
