		...
		<div class="card">
			<div class="card-body">
				...
				<form action="<?= base_url() ?>toolman/submitSubmission" method="POST">
					...
					<?php if ($submission_history_data['status'] >= 4 && $submission_history_data['status'] < 6) : ?>
					<div class="col-12 mt-3 p-3 bg-body-secondary">
						<h5 for="" class="form-label text-center">Konfirmasi Pengajuan</h5>
						<div class="row col-lg-12">
							<div class="col-lg-6">
								<a href="<?= base_url() ?>headschool/rejectSubmission/<?=$submission_history_data['id']?>_<?=$submission_history_data['submission_id']?>">
									<div class="d-grid">
							...
							<div class="col-lg-6">
								<a href="<?= base_url() ?>headschool/acceptSubmission/<?=$submission_history_data['id']?>_<?=$submission_history_data['submission_id']?>">
									<div class="d-grid">
