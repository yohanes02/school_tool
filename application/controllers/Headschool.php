...
class Headschool extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view("headschool/v_item_page", $data);
	...
	public function detailItem($id)
	{
		...
		$this->load->view("component/v_header", $data);
		$this->load->view("component/v_sidebar");
		$this->load->view("headschool/v_item_detail_page", $data);
		$this->load->view("component/v_bottom");
	}
	...
	public function submission()
	{
		...
		$this->load->view("component/v_header", $data);
		$this->load->view("component/v_sidebar");
		$this->load->view("headschool/v_submission_page", $data);
		$this->load->view("component/v_bottom");
	}
	...
	public function detailSubmission($id)
	{
		...
		$this->load->view("component/v_header", $data);
		$this->load->view("component/v_sidebar");
		$this->load->view("headschool/v_detail_submission", $data);
		$this->load->view("component/v_bottom");
	}
	...
	public function detailHistorySubmission($id)
	{
		...
		$this->load->view("component/v_header", $data);
		$this->load->view("component/v_sidebar");
		$this->load->view("headschool/v_detail_history_submission", $data);
	...
	public function acceptSubmission($history_id_submission_id)
	{
		...
		redirect("headschool/detailSubmission/" . $submission_id);
	}
